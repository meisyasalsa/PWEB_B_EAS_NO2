...
<head>
    ...
    <title>Pendaftaran Calon Pegawai</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 shadow" style="width:100%">
        <div class="container">
            <a class="navbar-brand" href="https://kkp.go.id/">
                <img src="../../assets/img/logo.png" width="30" height="30" alt="logosmk">
                <span class="align-middle">KEMENTERIAN KELAUTAN DAN PERIKANAN
        ...
        <div class="container text-light">
            <div class="row p-4">
                <div class="col text-center">
                    <h4>CONTACT</h4>
                    <div>
                        <p class="m-2"><i class="fa fa-envelope mr-2"></i>humas.kkp@kkp.go.id</p>
                        <p class="m-2"><i class="fa fa-phone mr-2"></i>0274-367156 / 0274-6462740</p>
                        <p class="m-2"><i class="fa fa-fax mr-2"></i>0232123456</p>
                    </div>
                    <div>
                        <a href="https://www.instagram.com" class="text-light mx-1"><i
                ...
                <div class="col text-center">
                    <h4>ADDRESS</h4>
                    <p>JL. Medan Merdeka Timur No.16 <br>Jakarta Pusat</p>
                </div>
                <div class="col text-center">
                    <h4>NAVIGATE</h4>
